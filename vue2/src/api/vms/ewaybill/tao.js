...
export function pullWaybillAccount(data) {
  return request({
    url: '/api/oms-api/tao/ewaybill/pull_waybill_account',
    method: 'post',
    data: data
  })
}
...
export function getWaybillCode(data) {
  return request({
    url: '/api/oms-api/tao/ewaybill/get_waybill_code',
    method: 'post',
    data: data
  })
}
...
export function getWaybillPrintData(data) {
  return request({
    url: '/api/oms-api/tao/ewaybill/get_print_data',
    method: 'post',
    data: data
  })
}
...
export function pushWaybillPrintSuccess(data) {
  return request({
    url: '/api/oms-api/tao/ewaybill/push_print_success',
    method: 'post',
    data: data
  })
}
...
export function pushShipSend(data) {
  return request({
    url: '/api/oms-api/tao/ewaybill/push_ship_send',
    method: 'post',
    data: data
  })
}
