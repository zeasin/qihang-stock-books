...
<!--      <el-table-column label="ID" align="center" prop="id" />-->
      ...
      <el-table-column label="店铺负责人" align="center" prop="manageUserId" >
        <template slot-scope="scope">
          <el-tag >
            {{userList.find(x=>x.userId === scope.row.manageUserId).nickName
            }}
          </el-tag>
        </template>
      </el-table-column>
...
<!--       <el-table-column label="规格" align="center" prop="skuName" />-->
      <el-table-column label="小组" align="center" prop="shopGroupId," >
        <template slot-scope="scope">
          <el-tag >{{groupList.find(x=>x.id === scope.row.shopGroupId)?groupList.find(x=>x.id === scope.row.shopGroupId).name:''}}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="总金额" align="center" prop="orderAmount" :formatter="amountFormatter" width="200px" :sort-method="sortOrderAmount"  :sortable="true">
        <template slot-scope="scope">
      ...
      <el-table-column label="刷单金额" align="center" prop="falseOrderAmount" :formatter="amountFormatter" width="200px" :sort-method="sortFalseOrderAmount" :sortable="true">
        <template slot-scope="scope">
      ...
      <el-table-column label="广告费" align="center" prop="adFee" :sort-method="sortAdFee" :sortable="true">
        <template slot-scope="scope">
...
import {listRegionDaily} from "@/api/report/report";
