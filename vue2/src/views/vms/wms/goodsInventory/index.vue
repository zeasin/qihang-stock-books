<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="120px">
      <el-form-item label="商家商品名称" prop="goodsName">
        <el-input
...
<!--      <el-table-column type="selection" width="55" align="center" />-->
      ...
      <el-table-column label="商家编码" align="left" prop="erpGoodsNo" />
      ...
      <el-table-column label="有效库存" align="center" prop="usableNum" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="850px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-table :data="erpGoodsInventoryDetailList" :row-class-name="rowErpGoodsInventoryDetailIndex" ref="erpGoodsInventoryDetail">
          ...
          <el-table-column label="商品编码" prop="goodsNo" width="150" />
...
<script>
import { listGoodsStock, getGoodsStock } from "@/api/vms/wms/goods_inventory";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listGoodsStock(this.queryParams).then(response => {
    ...
    handleUpdate(row) {
      ...
      getGoodsStock(id).then(response => {
