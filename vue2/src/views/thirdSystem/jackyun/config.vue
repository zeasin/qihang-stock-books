  ...
  <div class="app-container">
    <el-form ref="ruleForm" :model="form" :rules="rules" label-width="100px">
      ...
      <el-form-item label="服务器Url" prop="apiUrl">
        <el-input v-model="form.apiUrl" style="width: 450px"></el-input>
      </el-form-item>
      <el-form-item label="AppKey" prop="appKey">
        <el-input v-model="form.appKey" style="width: 450px"></el-input>
      </el-form-item>
      <el-form-item label="AppSecret" prop="appSecret">
        <el-input v-model="form.appSecret" style="width: 450px"></el-input>
      </el-form-item>
      <el-form-item label="回调Url" prop="callbackUrl">
        <el-input v-model="form.callbackUrl" style="width: 450px"></el-input>
      </el-form-item>
      <el-form-item label="Token" prop="accountToken">
        <el-input v-model="form.accountToken" style="width: 450px"></el-input>
      </el-form-item>
...
import {getInternalSystemConfig,saveInternalSystemConfig} from "@/api/third_system/index";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        // accountToken: [{ required: true, message: '请输入Token', trigger: 'change' }],
        callbackUrl: [{ required: true, message: '请添加回调URL', trigger: 'change' }],
        // type: [
  ...
  mounted() {
    getInternalSystemConfig(this.form.systemId).then(response => {
      if(response.data){
