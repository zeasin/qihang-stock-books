...
-- ----------------------------
-- Table structure for erp_bill_shipment
-- ----------------------------
DROP TABLE IF EXISTS `erp_bill_shipment`;
CREATE TABLE `erp_bill_shipment`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `type` int NOT NULL COMMENT '账单类型1自己发货2供应商发货',
  ...
  `package_amount` decimal(5, 2) NOT NULL DEFAULT 0.00 COMMENT '包装费用',
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '账单-发货账单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for erp_bill_shop_accounts
-- ----------------------------
DROP TABLE IF EXISTS `erp_bill_shop_accounts`;
CREATE TABLE `erp_bill_shop_accounts`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `type` int NOT NULL COMMENT '账单类型1支出2收入',
  `tenant_id` bigint NOT NULL COMMENT '租户id',
  `shop_id` bigint NOT NULL COMMENT '店铺id',
  `trade_time` datetime NOT NULL COMMENT '交易时间',
  `date` date NOT NULL COMMENT '日期',
  `amount` decimal(10, 2) NOT NULL COMMENT '应付总金额',
  `usage_scenario` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用途',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `status` int NOT NULL COMMENT '状态（0已生成1已结算)',
  `create_time` datetime NULL DEFAULT NULL COMMENT '订单创建时间',
  `create_by` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '创建人',
  ...
  `update_by` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '店铺账目表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for erp_bill_shop_order
-- ----------------------------
DROP TABLE IF EXISTS `erp_bill_shop_order`;
CREATE TABLE `erp_bill_shop_order`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `shop_id` bigint NOT NULL,
  `shop_type` int NOT NULL,
  `tenant_id` bigint NOT NULL,
  `order_id` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '订单号',
  `type` int NOT NULL COMMENT '1收入2支出',
  `amount` float NOT NULL COMMENT '金额',
  `biz_time` datetime NOT NULL COMMENT '业务时间',
  `biz_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '服务类型',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `detail` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '店铺账单' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品库存表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `erp_goods_inventory_operation`  (
  ...
  `update_by` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '仓库库存操作记录表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品规格' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `erp_logistics_company`  (
  ...
  `tenant_id` bigint NULL DEFAULT NULL COMMENT '租户id',
  `logistics_id` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '物流公司id（值来自于平台返回）',
...
CREATE TABLE `erp_order`  (
  ...
  `receiver_name_mask` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收件人姓名',
  ...
  `receiver_address` varchar(350) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '收件人地址，不拼接省市区。加密',
  ...
  `ship_type` int NULL DEFAULT NULL COMMENT '发货方式1电子面单发货2手动发货',
  ...
  `waybill_code` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '取单单号',
  `waybill_status` int NOT NULL DEFAULT 0 COMMENT '取单状态0未取单1已取单',
  `waybill_time` datetime NULL DEFAULT NULL COMMENT '取单时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `order_sn_index`(`order_num`) USING BTREE,
  INDEX `shopid_index`(`shop_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for erp_order_after_sale
-- ----------------------------
DROP TABLE IF EXISTS `erp_order_after_sale`;
CREATE TABLE `erp_order_after_sale`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `goods_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '商品spuid',
  ...
  `erp_sku_id` bigint NULL DEFAULT NULL COMMENT 'ERP商品skuId',
  ...
  `status` int NULL DEFAULT NULL COMMENT '状态:0等待用户发货1用户已发货；2已收货；3已入库',
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
  `create_time` datetime NULL DEFAULT NULL,
  `create_by` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `update_time` datetime NULL DEFAULT NULL,
  `update_by` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `shipping_status` int NULL DEFAULT 0 COMMENT '订单发货状态 0:未发货， 1:已发货（包含：已发货，已揽收）',
  `user_shipping_status` int NULL DEFAULT 0 COMMENT '用户发货状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '售后处理表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `erp_order_item`  (
  ...
  `update_by` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '更新人',
  `ship_status` int NOT NULL DEFAULT 0 COMMENT '发货状态 0 待发货 1 已分配供应商发货 2全部发货',
  `shipper` int NOT NULL DEFAULT 0 COMMENT '发货方 0 自己发货1联合发货2供应商发货',
  `ship_type` int NULL DEFAULT NULL COMMENT '发货方式1电子面单发货2手动发货',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `erp_order_ship_list`  (
  ...
  `update_by` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '发货-备货表（取号发货加入备货清单、分配供应商发货加入备货清单）' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for erp_order_ship_waybill
-- ----------------------------
DROP TABLE IF EXISTS `erp_order_ship_waybill`;
CREATE TABLE `erp_order_ship_waybill`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tentant_id` bigint NOT NULL COMMENT '租户id',
  `shop_id` bigint NOT NULL COMMENT '店铺id',
  `shop_type` int NOT NULL COMMENT '店铺类型',
  `order_num` varchar(35) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '订单号',
  `erp_order_id` bigint NOT NULL COMMENT '发货订单ID',
  ...
  `status` int NOT NULL COMMENT '状态（1已取号2已打印3已发货）',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '发货-电子面单记录表（打单记录）' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `erp_purchase_order`  (
  ...
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 474 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `erp_purchase_order_item`  (
  ...
  INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1969 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单明细' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `erp_purchase_order_payable`  (
  ...
  `update_by` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '更新人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购单应付款' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `erp_purchase_order_ship`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 472 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '采购订单物流表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `erp_shipment`  (
  ...
  `trace` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '物流轨迹json',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `erp_shop`  (
  ...
  `expires_in` bigint NULL DEFAULT NULL COMMENT '到期时长',
  `expires_at` bigint NULL DEFAULT NULL COMMENT '到期时间',
  ...
  `api_status` int NOT NULL DEFAULT 0 COMMENT 'api调用状态0未开启1已开启',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `erp_shop_goods_sku`  (
  ...
  `out_sku_id` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '商家自定义skuID。如果添加时没录入，回包可能不包含该字段',
...
-- ----------------------------
-- Table structure for erp_shop_message
-- ----------------------------
DROP TABLE IF EXISTS `erp_shop_message`;
CREATE TABLE `erp_shop_message`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint NOT NULL,
  `shop_type` int NOT NULL COMMENT '3pdd5wei',
  `event_type` varchar(55) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '事件类型',
  `event_content` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '事件内容',
  `seller_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '卖家ID',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '店铺消息处理' ROW_FORMAT = Dynamic;
...
CREATE TABLE `erp_shop_order`  (
  ...
  `shop_id` bigint NOT NULL COMMENT '店铺id',
  `shop_type` int NOT NULL COMMENT '店铺类型',
  `order_model` int NOT NULL DEFAULT 0 COMMENT '订单模式0拉取模式1人工模式',
  `order_id` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '订单号',
  ...
  `settle_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '结算信息json',
...
CREATE TABLE `erp_shop_pull_logs`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 38 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '更新日志表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `erp_shop_task`  (
  ...
  `shop_id` bigint NOT NULL COMMENT '店铺id',
  `shop_type` int NOT NULL COMMENT '店铺类型',
  `task_type` int NOT NULL COMMENT '任务类型（1拉取订单',
  ...
  `remark` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `status` int NOT NULL COMMENT '状态1启用0禁用',
  `create_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Table structure for erp_shop_waybill_account
-- ----------------------------
DROP TABLE IF EXISTS `erp_shop_waybill_account`;
CREATE TABLE `erp_shop_waybill_account`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint NOT NULL COMMENT '租户id',
  `shop_id` bigint NOT NULL COMMENT '店铺id',
  ...
  `supplier_ids` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '供应商id集合',
  `template_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '打印模版url',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '店铺电子面单账户信息表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Table structure for erp_shop_waybill_template
-- ----------------------------
DROP TABLE IF EXISTS `erp_shop_waybill_template`;
CREATE TABLE `erp_shop_waybill_template`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `tenant_id` bigint NOT NULL COMMENT '租户id',
  `shop_type` int NOT NULL COMMENT '店铺类型3拼多多5微信小店9其他',
...
CREATE TABLE `erp_stock_in`  (
  ...
  `tenant_id` bigint NOT NULL COMMENT '租户 id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '入库单' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_license`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `uuid` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'uuid',
  `time` bigint NULL DEFAULT NULL COMMENT '时间戳',
  `startup_count` int NULL DEFAULT 1 COMMENT '启动次数',
  `status` int NULL DEFAULT 0 COMMENT '是否授权1已授权0未授权',
...
) ENGINE = InnoDB AUTO_INCREMENT = 167 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户信息表' ROW_FORMAT = DYNAMIC;
